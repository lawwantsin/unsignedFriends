...
It's a PostGreSQL dump of the 13K person list given to me by Tony Green and the Secretary of State's office.
...
It still needs the data in the Heroku database.
That's covered in this article.
https://devcenter.heroku.com/articles/heroku-postgres-import-export

But the command is something like this.
heroku pgbackups:restore DATABASE 'https://somewhereonline.com/mydb.dump'  <= Address of the Data dump somewhere online.
